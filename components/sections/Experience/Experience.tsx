...
const roles = [
  {
    ...
    stack: ["Next.js", "React Query", "Zustand", "Sentry"],
  },
  {
    id: 2,
    period: "2020 – 2022",
  ...
  return (
    ...
    >
      ...
      <article className="group relative overflow-hidden rounded-3xl border border-black/5 bg-white/80 p-8 shadow-xl backdrop-blur transition-all duration-300 hover:border-emerald-500/20 hover:shadow-2xl dark:border-white/10 dark:bg-neutral-900/70 dark:hover:border-emerald-500/30">
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-emerald-500/0 via-emerald-500/0 to-emerald-500/5 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
      ...
      <SectionReveal variant="fadeUp">
        <section id="experience" className="w-full px-4 py-12 md:py-20">
          ...
          <div className="relative mx-auto mt-12 flex w-full max-w-5xl flex-col gap-10">
            {/* Timeline line */}
            <div className="absolute left-4 top-0 bottom-0 hidden w-px bg-gradient-to-b from-emerald-200 via-emerald-300 to-emerald-200 md:block" />
